...
export const LATEST_UPDATES: AppUpdate[] = [
  {
    date: "7 May",
    type: "alert",
    text: "🚚 Holiday Order Cut-Offs: 17 May – 4 June 2026",
    subtext: "Hari Raya Haji (27–28 May), Wesak Day (31 May & 2–3 Jun), Agong's Birthday (1 Jun), Hari Gawai (1–2, 4 Jun). East Malaysia & K/T resumes from 3–5 Jun. Check delivery windows before ordering.",
  },
  {
    date: "7 May",
    type: "new",
